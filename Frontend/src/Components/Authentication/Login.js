                            ...
                            <div class="card-stacked">
                                <div class="card-content">
                                    ...
                                    <div id="login-form-box">
                                        <h5>Username</h5>
                                        <div id="search-form">
                                            <input type="search" id="query" name="q" placeholder='username' onChange={(e) => { setUsername1(e.target.value) }} ></input>
                                        </div>
                                        <h5>Password</h5>
                                        <div id="search-form">

                                            <input type="password" id="query" name="q" placeholder='password' onChange={(e) => { setPassword1(e.target.value) }}></input>
